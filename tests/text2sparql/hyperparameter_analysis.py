...
def plot_proportion_tuning_results(results: pd.DataFrame) -> None:
    ...
    ax.set_xticks([.05, .10, .20, .50, .95], ['5%', '10%', '20%', '50%', '95%'])
    ax.set_yticks([.2, .3, .4, .5, .6, .7], ['.2', '.3', '.4', '.5', '.6', '.7'])
...
if __name__ == "__main__":
    ...
    results = pd.DataFrame([
        {'proportion': .05, 'dataset': 'DBpedia (EN)', 'F1 Score': .62},
        {'proportion': .10, 'dataset': 'DBpedia (EN)', 'F1 Score': .68},
        {'proportion': .20, 'dataset': 'DBpedia (EN)', 'F1 Score': .61},
        {'proportion': .50, 'dataset': 'DBpedia (EN)', 'F1 Score': .63},
        {'proportion': .95, 'dataset': 'DBpedia (EN)', 'F1 Score': .66},
        {'proportion': .05, 'dataset': 'DBpedia (ES)', 'F1 Score': .56},
        {'proportion': .10, 'dataset': 'DBpedia (ES)', 'F1 Score': .64},
        {'proportion': .20, 'dataset': 'DBpedia (ES)', 'F1 Score': .58},
        {'proportion': .50, 'dataset': 'DBpedia (ES)', 'F1 Score': .60},
    ...
    results = pd.DataFrame([
        ...
        {'examples': 5, 'dataset': 'DBpedia (EN)', 'F1 Score': .59},
        {'examples': 10, 'dataset': 'DBpedia (EN)', 'F1 Score': .68},
        {'examples': 20, 'dataset': 'DBpedia (EN)', 'F1 Score': .63},
        {'examples': 1, 'dataset': 'DBpedia (ES)', 'F1 Score': .46},
        {'examples': 5, 'dataset': 'DBpedia (ES)', 'F1 Score': .58},
        {'examples': 10, 'dataset': 'DBpedia (ES)', 'F1 Score': .64},
        {'examples': 20, 'dataset': 'DBpedia (ES)', 'F1 Score': .69},
        {'examples': 1, 'dataset': 'Corporate', 'F1 Score': .27},
        {'examples': 5, 'dataset': 'Corporate', 'F1 Score': .40},
        {'examples': 10, 'dataset': 'Corporate', 'F1 Score': .44},
        {'examples': 20, 'dataset': 'Corporate', 'F1 Score': .44},
        {'examples': 1, 'dataset': 'Overall', 'F1 Score': .38},
        {'examples': 5, 'dataset': 'Overall', 'F1 Score': .49},
        {'examples': 10, 'dataset': 'Overall', 'F1 Score': .55},
        {'examples': 20, 'dataset': 'Overall', 'F1 Score': .55},
    ])
